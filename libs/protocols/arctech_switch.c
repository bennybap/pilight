...
static void arctechSwParseBinary(void) {
	...
	for (counter = 0; counter < MAX_ID_NRS; counter += 2) {
		...
		if (arctech_switch->idUnitnrs[counter]  == -1) {	// end of list reached
			break;
		}	
	}
...
void arctechSwInit(void) {
	...
	arctech_switch->idUnitnrs[8] = 3801158;
	arctech_switch->idUnitnrs[9] = 1;		
	arctech_switch->idUnitnrs[10] = 3801158;
	arctech_switch->idUnitnrs[11] = 2;				
	arctech_switch->idUnitnrs[12] = 11223898;
	arctech_switch->idUnitnrs[13] = 9;	
	arctech_switch->idUnitnrs[14] = 11461082;
	arctech_switch->idUnitnrs[15] = 9;	
	arctech_switch->idUnitnrs[16] = 9787534;
	arctech_switch->idUnitnrs[17] = 11;	
	arctech_switch->idUnitnrs[18] = 10711386;
	arctech_switch->idUnitnrs[19] = 9;		
	arctech_switch->idUnitnrs[20] = 11207438;
	arctech_switch->idUnitnrs[21] = 9;	
	arctech_switch->idUnitnrs[22] = 9787534;
	arctech_switch->idUnitnrs[23] = 10;	
	arctech_switch->idUnitnrs[24] = 10703366;
	arctech_switch->idUnitnrs[25] = 9;	
	arctech_switch->idUnitnrs[26] = 11225598;
	arctech_switch->idUnitnrs[27] = 9;		
	arctech_switch->idUnitnrs[28] = 11211686;
	arctech_switch->idUnitnrs[29] = 9;	
	arctech_switch->idUnitnrs[30] = 10706734;
	arctech_switch->idUnitnrs[31] = 9;	
	arctech_switch->idUnitnrs[32] = 3819430;
	arctech_switch->idUnitnrs[33] = 0;	
	arctech_switch->idUnitnrs[34] = 10709846;
	arctech_switch->idUnitnrs[35] = 9;		
	arctech_switch->idUnitnrs[36] = 10710574;
	arctech_switch->idUnitnrs[37] = 9;	
	arctech_switch->idUnitnrs[38] = 3819430;
	arctech_switch->idUnitnrs[39] = 0;		
	arctech_switch->idUnitnrs[40] = 3819430;
	arctech_switch->idUnitnrs[41] = 1;		
	arctech_switch->idUnitnrs[42] = 3819430;
	arctech_switch->idUnitnrs[43] = 2;					
